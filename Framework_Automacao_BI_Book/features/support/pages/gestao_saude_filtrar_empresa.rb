...
class GestaoSaudeFiltrarEmpresa < Test::Unit::TestCase
  ...
  def obter_dados_do_relatorio31_filial_empresa
	...
	# Filial Empresa = 120624/000, 120624/001, 120624/002, 120624/003, 120624/004, 120624/005, 120624/006, 120624/007, 120624/008  #
	# Data Competência = Última competência mais 2 competências anteriores														   #
	# Empresas = 120624													   														   #
	# Moeda = Real   																											   #
	# 																															   #
	#------------------------------------------------------------------------------------------------------------------------------#
	def conferir_dados_do_relatorio31_03(competencia1, competencia2, competencia3)
