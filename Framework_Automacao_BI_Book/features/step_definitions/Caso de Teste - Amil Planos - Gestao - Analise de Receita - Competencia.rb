Quando("seleciono a opção Amil Planos - Gestão") do
	on(MenusTopo).selecionar_menu_amil_planos_gestao
end

E("seleciono a opção Análise de Receita - Competência no menu Amil Planos - Gestão") do
  navigate_to(OpcoesMenuAmilPlanosGestao, :using => :rotas_menu_amil_planos_gestao).selecionar_analise_de_receita_competencia_menu_amil_planos_gestao
end
