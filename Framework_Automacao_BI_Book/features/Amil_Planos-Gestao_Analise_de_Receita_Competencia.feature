...
#language: pt
@Relatorio97
Funcionalidade: Analisar Relatórios Amil Planos - Gestão - Análise de Receita - Competência
...
@cenario1_relatorio97	 
Esquema do Cenário: Gerar relatório 97 para a Empresa 000509 e verificar os resultados apresentados para 3 últimas competências

	Quando seleciono a opção Amil Planos - Gestão
	E seleciono a opção Análise de Receita - Competência no menu Amil Planos - Gestão
